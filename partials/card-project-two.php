...
<!-- Card project -->
	<div class="swiper-slide">
		<a href="#" class="card-doc-two radius-3 trans-3">
			<div class="top-actions">
				...
				<span class="delete trans-3" data-toggle="modal" data-target="#deleteModal" title="Remove"><i class="icon-trash" data-toggle="tooltip" data-placement="bottom" ></i></span> 
			</div>
